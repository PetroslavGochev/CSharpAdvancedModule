...
namespace Stealer
{
    public class Spy
    {
        ...
        public string StealFieldInfo(string nameOfClass, params string[] namesToInvestigate)
        {
            StringBuilder sb = new StringBuilder();
            Type typeOfClass = Type.GetType(nameOfClass);
            FieldInfo[] classFields = typeOfClass.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance);
            ...
            foreach (var item in classFields.Where(x=>namesToInvestigate.Contains(x.Name)))
            {
        ...
        public string RevealPrivateMethods(string className)
        {
            StringBuilder sb = new StringBuilder();
            Type typeOfClass = Type.GetType(className);
            MethodInfo[] allPrivateMethod = typeOfClass.GetMethods(BindingFlags.NonPublic | BindingFlags.Instance);
